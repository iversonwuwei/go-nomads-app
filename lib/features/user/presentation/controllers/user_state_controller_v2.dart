...
/// 3. 智能缓存策略
/// 4. 保留所有原有功能
class UserStateControllerV2 extends GetxController {
  // ==================== Dependencies ====================
  ...
  void _setupAuthStateListener() {
    try {
      ...
      ever(authController.isAuthenticated, (isAuthenticated) {
        log('🔔 UserStateControllerV2: 认证状态变化 -> $isAuthenticated');
        if (isAuthenticated) {
          log('✅ 用户已登录，加载用户数据...');
          loadCurrentUser();
          loadFavoriteCityIds();
