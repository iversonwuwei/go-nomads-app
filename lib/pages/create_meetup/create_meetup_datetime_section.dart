              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      border: Border.all(color: AppColors.borderLight), borderRadius: BorderRadius.circular(8.r)),
                  child: Row(
                    children: [
                      ...
                      Obx(() => Text(
                            ...
                            style: TextStyle(
                                fontSize: 14.sp, color: _c.selectedDate.value == null ? Colors.grey : Colors.black87),
                          )),
                    ],
                  ),
                ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Obx(() => Text(
                            ...
                            style: TextStyle(
                                fontSize: 14.sp, color: _c.selectedTime.value == null ? Colors.grey : Colors.black87),
                          )),
                    ],
                  ),
                ),
