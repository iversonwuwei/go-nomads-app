              ...
              children: [
                ...
                if (controller.stats.value != null) ...[
                  ...
                  GridView.count(
                    ...
                    children: [
                      _buildStatCard(
                          '国家', controller.stats.value!.countriesVisited, FontAwesomeIcons.flag, Colors.blue),
                      ...
                      _buildStatCard(l10n.modularProfileStatDays, controller.stats.value!.daysNomading,
                          FontAwesomeIcons.calendar, Colors.orange),
                      _buildStatCard(l10n.modularProfileStatMeetups, controller.stats.value!.meetupsAttended,
                          FontAwesomeIcons.userGroup, Colors.purple),
                      _buildStatCard(l10n.modularProfileStatTrips, controller.stats.value!.tripsCompleted,
                          FontAwesomeIcons.ticketSimple, Colors.red),
                      _buildStatCard(l10n.modularProfileStatReviews, controller.stats.value!.reviewsWritten,
