...
/// 邮箱登录表单 - 使用 GetView 模式
class EmailLoginForm extends GetView<NomadsLoginPageController> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<NomadsLoginPageController>(
      tag: controllerTag,
      builder: (c) => Column(
        ...
        children: [
          ...
          Obx(() => TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    icon: Icon(c.obscurePassword.value ? FontAwesomeIcons.eye : FontAwesomeIcons.eyeSlash),
              ...
              Row(
                children: [
                  Obx(() => Checkbox(
                        ...
                        onChanged: (value) => c.setRememberMe(value ?? false),
          ...
          // 登录按钮
          ElevatedButton(
            onPressed: () => c.loginWithEmail(context),
...
/// 手机号登录表单 - 使用 GetView 模式
class PhoneLoginForm extends GetView<NomadsLoginPageController> {
  final String controllerTag;
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: TextFormField(
                  controller: c.smsCodeController,
              ...
              SizedBox(
                ...
                child: Obx(() => ElevatedButton(
                      onPressed: c.countdown.value > 0 ? null : c.sendSmsCode,
                      style: ElevatedButton.styleFrom(
                        backgroundColor: NomadsLoginPageController.nomadsRed,
                        foregroundColor: Colors.white,
                      ...
                      child: Text(
                        c.countdown.value > 0 ? '${c.countdown.value}s' : '发送验证码',
          ...
          // 手机登录按钮
          ElevatedButton(
            onPressed: () => c.loginWithPhone(context),
            style: ElevatedButton.styleFrom(
              backgroundColor: NomadsLoginPageController.nomadsRed,
              foregroundColor: Colors.white,
              padding: const EdgeInsets.symmetric(vertical: 16),
          ...
          Center(
            child: TextButton(
              onPressed: () => c.setLoginMode(LoginMode.email),
              child: const Text(
                '使用邮箱密码登录',
